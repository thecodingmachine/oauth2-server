...
* If you need to perform changes, edit the OauthClientDao class instead!
*/
...
use Mouf\OauthServer\Model\Entities\OauthClient;

/**
* The OauthClientBaseDao class will maintain the persistance of OauthClient class into the oauth_clients table.
*
*/
class OauthClientBaseDao extends EntityRepository implements DAOInterface {

	/**
	 * @param EntityManager $entityManager
	 */
	public function __construct($entityManager){
		parent::__construct($entityManager, $entityManager->getClassMetadata('Mouf\OauthServer\Model\Entities\OauthClient'));
	}


	/**
	 * Get a new bean record
	 * * @return OauthClient the new bean object
	 */
	 ...
	 * @param mixed $id
	 * @return OauthClient the bean object
	 */
	 ...
	 * @return array[OauthClient] array of bean objects
	 */
    ...
    public function findUniqueBy(array $criteria)
    {
        ...
        if(count($result) == 1){
            ...
            throw new NonUniqueResultException('More than one OauthClient was found');
        }else{
           return null;
        }
    }
